...
<html lang="en">
    ...
    <body>
      ...
      <div class="container">
        <nav class="navbar navbar-expand-lg main-nav px-0">
          ...
          <div class="collapse navbar-collapse" id="mainMenu">
            <ul class="navbar-nav ml-auto text-uppercase f1">
              ...
              <li>
                  <a href="list.php" class="active active-first">Top List</a>
              </li>
              <li>
        ...
        $sql1 = "SELECT LIST.name AS 'List', COUNT(LIKES.listid) AS 'Like' FROM USER
                                    ...
                                    ORDER BY COUNT(LIKES.listid) DESC LIMIT 10";
         if ($result1 = mysqli_query($connection, $sql1))
        {
            ...
            {
                $dataPoints[] = array("label" => $row['List'], "y" =>  $row['Like']);
            }
        ...
        <div class="py-5">
            ...
            <div class="col-lg-6">
                <div class="row">
                <h2 class="display-4 font-weight-light">Number of Top List</h2>
